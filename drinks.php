            ...
            <div class="flex">
                ...
                <p class="flex-item">
                    ...
                    <select name="subcategory" id="subcategory">
                        ...
                        <option value="Rött vin" <?php if ($subcategory == "Rött vin") echo 'selected=""'; ?>>Rött vin</option>
                        <option value="Vitt vin" <?php if ($subcategory == "Vitt vin") echo 'selected=""'; ?>>Vitt vin</option>
                        <option value="Öl och cider" <?php if ($subcategory == "Öl och cider") echo 'selected=""'; ?>>Öl och cider</option>
                        <option value="Alkoholfritt" <?php if ($subcategory == "Alkoholfritt") echo 'selected=""'; ?>>Alkoholfritt</option>
                    </select>
                    <br />
                    <?php
                    // If statement that checks if variable has been set
            ...
            <tbody>
                ...
                if (!array_key_exists("message", $data)) {
                    ...
                    foreach ($data as $menuitem) {
                        ...
                        if ($menuitem["subcategory"] === "Rött vin") {
        ...
        <table>
            ...
            <tbody>
                ...
                if (!array_key_exists("message", $data)) {
                    ...
                    foreach ($data as $menuitem) {
                        // If statement that checks if the object belongs to a certain subcategory 
                        if ($menuitem["subcategory"] === "Vitt vin") {
                            // Prints information of menuitem
                ?>
                            <tr>
                                <td><?= $menuitem["name"] ?></td>
        ...
        <table>
            ...
            <tbody>
                ...
                if (!array_key_exists("message", $data)) {
                    ...
                    foreach ($data as $menuitem) {
                        // If statement that checks if the object belongs to a certain subcategory 
                        if ($menuitem["subcategory"] === "Öl och cider") {
                            // Prints information of menuitem
                ?>
                            <tr>
                                <td><?= $menuitem["name"] ?></td>
        ...
        <table>
            ...
            <tbody>
                ...
                if (!array_key_exists("message", $data)) {
                    ...
                    foreach ($data as $menuitem) {
                        // If statement that checks if the object belongs to a certain subcategory 
                        if ($menuitem["subcategory"] === "Alkoholfritt") {
                            // Prints information of menuitem
                ?>
                            <tr>
                                <td><?= $menuitem["name"] ?></td>
                                ...
                                <td class="hidden-mobile"><?= $menuitem["description"] ?></td>
                                <td class="change"><a class="change-btn" href="editmenuitem.php?id=<?= $menuitem["id"] ?>">Ändra</a></td>
                                <td class="change"><a class="delete-btn" href="deletemenuitem.php?id=<?= $menuitem["id"] ?>">Radera</a></td>
                            </tr>
                <?php
                        }
                    }
