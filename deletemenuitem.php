...
$url = "https://studenter.miun.se/~sowi2102/writeable/dt173g/projekt/webservice/menuapi.php?id=" . $_GET['id'];
...
// Redirect to the page where the delete script was called from (not reliable?)
